...
% The main part of Federated Multi-view FCM with Consensus Prototypes
...
for r = 1:1  %1:19
    ...
    for d = 1:1 %1:12
        ...
        for k = 1:times
            ...
            [U0,V0] = Fed_initialUV(sub_Data,dd,c,q,mm,numview);
            tic
            [outU,outV,outAlpha,outObj,outNumIter] = federated_multi_FCMCP(sub_Data,dd,U0,V0,Alpha,q,mm,numview,maxIter);
            timer(k)  = toc;
